...
import './CustomerManager.scss'; // Import the SCSS file
  ...
  return (
    <div className="customer-container">
      <div className="max-w-6xl p-6">
        ...
        {/* Existing Customers Section moved here */}
              ...
              <li key={customer.id} className="flex justify-between items-center mb-2">
                <div className="flex justify-between flex-1">
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-600">E-post: {customer.email}</span>
                    <span className="text-gray-600">Telefon: {customer.phone}</span>
                  </div>
                </div>
